...
import { ReactFlow, addEdge, Background, useNodesState, useEdgesState, ConnectionLineType } from '@xyflow/react'
...
export default function MindmapPage()
{
  ...
  return (
    <div className="h-[90vh] w-full bg-gray-800 relative">
      <ReactFlow nodes={nodes} edges={edges} onNodesChange={onNodesChange} onEdgesChange={onEdgesChange} onConnect={onConnect} connectionLineType={ConnectionLineType.SmoothStep} fitView>
        <Background />
      </ReactFlow>
    </div>
  )
